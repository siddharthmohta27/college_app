...
(7, '8:30 AM – 9:00 AM', 'Attendance in respective rooms/Venue mentioned in Annexure 1 (Day 7)', 'Annexure 1 (Day 7) Venues', 'Respective Faculty Incharges & Student Branch Inchargess', 'morning', 99),
(7, '9:00 AM – 9:30 AM', 'Club Slot 26: Group A (ACM in Auditorium), Group B (EIC in L-28), Group C (WEC in L-29), Group D (NCC in L-30), Group E (Robotics in L-31), Group F (SAE in L-26), Group G (SESI in Aero Audi), Group H (SME in L-27)', 'Respective Venues', 'Faculty & Student Branch Incharges', 'morning', 100),
(7, '9:30 AM – 10:00 AM', 'Club Slot 27: Group A (CIM in Auditorium), Group B (SAASC in L-28), Group C (IEEE in L-29), Group D (APC in L-30), Group E (SESI in L-31), Group F (Rotaract in L-26), Group G (SAASC in Aero Audi), Group H (ASPS in L-27)', 'Respective Venues', 'Faculty & Student Branch Incharges', 'morning', 101),
(7, '10:00 AM – 10:30 AM', 'Club Slot 28: Group D (IGS in L-30), Group E (ES in L-31), Group F (SCC in L-26), Group G (SAE in Aero Audi), Group H (EEB in L-27)', 'Respective Venues', 'Faculty & Student Branch Incharges', 'morning', 102),
(7, '10:30 AM – 11:00 AM', 'Club Slot 29: Group A (SESI in Auditorium), Group B (Rotaract in L-28), Group C (ASME in L-29), Group D (SCC in L-30), Group E (Rotaract in L-31), Group F (IIM in L-26), Group G (ASPS in Aero Audi), Group H (NSS in L-27)', 'Respective Venues', 'Faculty & Student Branch Incharges', 'morning', 103),
(7, '11:00 AM – 11:30 AM', 'Club Slot 30: Group D (IEEE in L-30), Group E (ATS in L-31), Group F (EEB in L-26), Group G (ES in Aero Audi), Group H (SCC in L-27)', 'Respective Venues', 'Faculty & Student Branch Incharges', 'morning', 104),
(7, '11:30 AM – 12:00 PM', 'Club Slot 31: Group D (WEC in L-30), Group E (NSS in L-31), Group F (Robotics in L-26), Group G (IEEE in Aero Audi), Group H (Rotaract in L-27)', 'Respective Venues', 'Faculty & Student Branch Incharges', 'morning', 105),
(7, '12:30 PM – 12:45 PM', 'Movement of Students to Respective Hostels', 'Campus', 'Student Branch Incharges', 'lunch', 106),
(7, '12:45 PM – 2:15 PM', 'Lunch', 'Annexure 3 Venues', 'Student Branch Incharges & Discipline Incharges', 'lunch', 107),
(7, '1:45 PM – 2:15 PM', 'Club Slot 32: Group A (PDC in Audi), Group B (PDC in Audi), Group C (NSS in L-29), Group D (ASPS in L-30), Group E (Rotaract in L-31), Group F (IGS in L-26), Group G (SME in Aero Audi), Group H (SAE in L-27)', 'Respective Venues', 'P/Is of Club, Societies, NSS & NCC', 'afternoon', 108),
(7, '2:15 PM – 2:45 PM', 'Club Slot 33: Group E (SAE in L-31), Group F (APC in L-26), Group H (PDC in L-27)', 'Respective Venues', 'P/Is of Club, Societies & Cells', 'afternoon', 109),
(7, '2:45 PM – 3:15 PM', 'Club Slot 34: Group C (ELC in L-29), Group F (ACM in L-26), Group H (ATS in L-27)', 'Respective Venues', 'P/Is of Club, Societies & Cells', 'afternoon', 110),
(7, '3:15 PM – 3:45 PM', 'Club Slot 35: Group F (SESI in L-26), Group H (CIM in L-27)', 'Respective Venues', 'P/Is of Club, Societies & Cells', 'afternoon', 111),
(7, '4:00 PM – 4:15 PM', 'Movement of Students', 'Campus', 'Student Branch Incharges & Discipline Incharges', 'afternoon', 112),
(7, '4:15 PM onwards', 'Grand FUN Event & Batch 2030 Celebrations 🎉', 'Auditorium / Campus', 'Student Branch Incharges & Cultural Committee', 'afternoon', 113);
