...
const TRENDING = [
  { text: "sproutX by EIC for startup funding & incubation grants", tag: "EIC / Startup", time: "Trending #1" },
  { text: "Clubs & Societies introduction sessions & freshers recruitments", tag: "Clubs", time: "Trending #2" },
  { text: "Orientation Day 1 reporting venues & campus navigation", tag: "Orientation", time: "Trending #3" },
  { text: "Kurukshetra Hostel Mess Menu live for the week", tag: "Mess Menu", time: "Trending #4" },
];
