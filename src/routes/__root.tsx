  ...
  head: () => ({
    meta: [
      ...
      { title: "Campus Connect — Your College, All in One Place" },
      {
        name: "description",
        content:
          "Campus Connect unifies your college marketplace, canteen menu, campus chat, clubs, events and study rooms in one premium app.",
      },
      ...
      { property: "og:title", content: "Campus Connect — Your College, All in One Place" },
      {
        ...
        content:
          "Marketplace, canteen, chat, clubs and study rooms — everything college, beautifully unified.",
      },
