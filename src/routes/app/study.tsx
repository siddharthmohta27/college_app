          ...
          {ROOMS.map((room, i) => {
            ...
            return (
              <div
                key={room.id}
                id={`room-${room.id}`}
                className={`rounded-2xl border glass p-5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg animate-fade-up ${statusColor}`}
          ...
          <div className="w-full max-w-md rounded-3xl glass-strong neon-border p-6 animate-fade-up">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 rounded-xl bg-primary py-2.5 text-sm font-semibold text-primary-foreground transition hover:opacity-90 disabled:opacity-40"
              >
                Confirm Booking
              </button>
            </div>
