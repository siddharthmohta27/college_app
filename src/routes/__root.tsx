...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Campus Connect unifies your college marketplace, canteen menu, campus chat, clubs, events and study rooms in one premium app." },
      { name: "author", content: "Campus Connect" },
      { property: "og:title", content: "Campus Connect — Your College, All in One Place" },
      { property: "og:description", content: "Marketplace, canteen, chat, clubs and study rooms — everything college, beautifully unified." },
