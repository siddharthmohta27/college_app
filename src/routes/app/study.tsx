...
const ROOMS: Room[] = [
  {
    ...
    occupied: 14,
    floor: "Ground Floor",
    features: ["Wi-Fi", "Whiteboard", "AC", "Projector"],
    isBooked: false,
    bookings: ["9:00", "10:00", "14:00", "15:00"],
  },
  {
    id: 2,
    name: "Quiet Zone B",
    ...
    occupied: 12,
    floor: "1st Floor",
    features: ["Wi-Fi", "AC", "No Phone"],
    isBooked: true,
    bookings: ["8:00", "9:00", "10:00", "11:00", "12:00", "13:00"],
  },
  {
    id: 3,
    name: "Group Room C",
    ...
    occupied: 3,
    floor: "1st Floor",
    features: ["Wi-Fi", "Whiteboard", "TV Screen"],
    isBooked: false,
  ...
  },
  {
    ...
    occupied: 21,
    floor: "2nd Floor",
    features: ["Wi-Fi", "Whiteboard", "AC", "Books"],
    isBooked: false,
    bookings: ["10:00", "11:00", "12:00", "16:00", "17:00"],
  },
  {
    id: 6,
    name: "Tech Lab F",
    ...
    occupied: 18,
    floor: "Ground Floor",
    features: ["Wi-Fi", "Computers", "AC", "Whiteboard"],
    isBooked: false,
    bookings: ["13:00", "14:00", "15:00", "16:00"],
  },
];
    ...
    <div className="mx-auto max-w-5xl space-y-8 p-6 pb-28 md:pb-8">
      ...
      <div className="animate-fade-up">
        ...
        <p className="mt-0.5 text-sm text-muted-foreground">
          Book a room, focus with a Pomodoro timer, and study smarter
        </p>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-4 lg:col-span-2 order-2 lg:order-1">
          ...
          <div className="flex items-center gap-4 text-xs text-muted-foreground animate-fade-up">
            ...
            <span className="flex items-center gap-1.5">
              <span className="h-2.5 w-2.5 rounded-full bg-amber-500" /> Almost Full
            </span>
            <span className="flex items-center gap-1.5">
              <span className="h-2.5 w-2.5 rounded-full bg-rose-500" /> Full
            </span>
            <span className="flex items-center gap-1.5">
              <span className="h-2.5 w-2.5 rounded-full bg-primary" /> Your Booking
            </span>
          </div>
                ...
                <div className="flex items-start justify-between gap-3 flex-wrap">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground flex items-center gap-2">
                      ...
                      {room.occupied}/{room.capacity} people
                    </p>
                  </div>
                  {!isMyBooking && pct < 1 ? (
                    <button
                    ...
                    <span className="rounded-xl bg-rose-500/10 px-4 py-2 text-xs font-semibold text-rose-400">
                      Full
                    </span>
                  )}
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-3xl glass-strong neon-border p-6 animate-fade-up">
            ...
            <p className="mb-5 text-sm text-muted-foreground">
              {selectedRoom.floor} · {selectedRoom.capacity} seats
            </p>
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-lg px-3 py-1.5 font-mono text-xs transition ${
                        taken
                          ? "cursor-not-allowed bg-rose-500/10 text-rose-400/60"
                          : bookingSlot === slot
                            ? "bg-primary text-primary-foreground"
                    ...
                    >
                      {taken ? (
                        ...
                        <Unlock className="inline h-3 w-3 mr-1 opacity-0 group-hover:opacity-100" />
                      )}
                      {slot}
                    </button>
                  );
