...
const SCHEDULE_DATA_BY_DAY: Record<number, ScheduleEvent[]> = {
  ...
  7: [
    { id: "d7-1", day: 7, time: "8:30 AM – 9:00 AM", activity: "Attendance in respective rooms/venue mentioned in Annexure 1 (Day 7)", venue: "Annexure 1 (Day 7)", coordinator: "Respective Faculty Incharges & Student Branch Inchargess", category: "morning", highlight: true },
    { id: "d7-2", day: 7, time: "9:15 AM – 9:45 AM", activity: "Group A (PDC in Auditorium), Group B (PDC in Auditorium), Group C (IEEE in Aero Auditorium), Group D (ASPS in L-30), Group F (IGS in L-26), Group G (SME in L-29), Group H (SAASC in L-27)", venue: "Auditorium / Aero Audi / L-30 / L-26 / L-29 / L-27", coordinator: "Respective Faculty Incharges & Student Branch Incharges", category: "morning" },
    { id: "d7-3", day: 7, time: "9:45 AM – 10:15 AM", activity: "Group A (ATS in Auditorium), Group B (ATS in Auditorium), Group C (EIC in Aero Auditorium), Group D (IGS in L-30), Group E (ELC in L-31), Group F (SCC in L-26), Group G (SAASC in L-29), Group H (EEB in L-27)", venue: "Auditorium / Aero Audi / L-30 / L-31 / L-26 / L-29 / L-27", coordinator: "Respective Faculty Incharges & Student Branch Incharges", category: "morning" },
    { id: "d7-4", day: 7, time: "10:15 AM – 10:45 AM", activity: "Group A (SAASC in Auditorium), Group B (SAASC in Auditorium), Group C (IGS in Aero Audi), Group D (ASCE in L-30), Group E (Rotaract in L-31), Group F (NCC in L-26), Group G (ASPS in L-29), Group H (SAE in L-27)", venue: "Auditorium / Aero Audi / L-30 / L-31 / L-26 / L-29 / L-27", coordinator: "Respective Faculty Incharges & Student Branch Incharges", category: "morning" },
    { id: "d7-5", day: 7, time: "10:45 AM – 11:15 AM", activity: "Group A (CIM in Auditorium), Group B (CIM in Auditorium), Group C (APC in Aero Audi), Group D (SAE in L-30), Group E (ES in L-31), Group F (HEB in L-26), Group G (SCC in L-29), Group H (ELC in L-27)", venue: "Auditorium / Aero Audi / L-30 / L-31 / L-26 / L-29 / L-27", coordinator: "Respective Faculty Incharges & Student Branch Incharges", category: "morning" },
    { id: "d7-6", day: 7, time: "11:30 AM – 12:30 PM", activity: "Speaker session", venue: "Auditorium", coordinator: "Organizing Committee", category: "morning", highlight: true },
    { id: "d7-7", day: 7, time: "12:30 PM – 12:45 PM", activity: "Movement of Students to Respective Hostels", venue: "Campus", coordinator: "Student Mentors & Discipline Incharges", category: "lunch" },
    { id: "d7-8", day: 7, time: "12:45 PM – 2:00 PM", activity: "Lunch", venue: "Annexure 3", coordinator: "Student Branch Incharges & Discipline Incharges", category: "lunch" },
    { id: "d7-9", day: 7, time: "2:00 PM – 2:45 PM", activity: "Orientation Quiz & CR Elections", venue: "Respective Rooms / Venues", coordinator: "Faculty & Student Branch Incharges", category: "afternoon", highlight: true },
    { id: "d7-10", day: 7, time: "2:45 PM – 3:15 PM", activity: "Group A (EEB in L-30), Group B (IEEE in L-28), Group C (WEC in Aero Audi), Group D (SESI in Auditorium), Group E (SAE in L-31), Group F (ACM in L-26), Group G (Rotaract in L-29), Group H (ATS in L-27)", venue: "L-30 / L-28 / Aero Audi / Auditorium / L-31 / L-26 / L-29 / L-27", coordinator: "Respective P/I's of Club, Societies, Cells, NSS & NCC", category: "afternoon" },
    { id: "d7-11", day: 7, time: "3:15 PM – 3:45 PM", activity: "Group A (SESI in L-30), Group B (Rotaract in L-28), Group C (ASME in Aero Audi), Group D (EIC in Auditorium), Group F (IIM in L-26), Group H (NSS in L-27)", venue: "L-30 / L-28 / Aero Audi / Auditorium / L-26 / L-27", coordinator: "Respective P/I's of Club, Societies, Cells, NSS & NCC", category: "afternoon" },
    { id: "d7-12", day: 7, time: "3:45 PM – 4:15 PM", activity: "Group A (SME in L-30), Group B (NCC in L-28), Group C (ES in Aero Audi), Group D (SCC in Auditorium), Group F (APC in L-26), Group H (PDC in L-27)", venue: "L-30 / L-28 / Aero Audi / Auditorium / L-26 / L-27", coordinator: "Respective P/I's of Club, Societies, Cells, NSS & NCC", category: "afternoon" },
    { id: "d7-13", day: 7, time: "4:15 PM – 4:45 PM", activity: "Group C (HEB in L-29)", venue: "Lecture Hall L-29", coordinator: "Respective P/I's of Club & Societies", category: "afternoon" },
    { id: "d7-14", day: 7, time: "4:15 PM – 4:30 PM", activity: "Movement of students", venue: "Campus", coordinator: "Student Branch Incharges & Discipline Incharges", category: "afternoon" },
    { id: "d7-15", day: 7, time: "4:30 PM onwards", activity: "Grand FUN Event 🎉", venue: "Auditorium / Campus", coordinator: "Student Branch Incharges & Cultural Committee", category: "afternoon", highlight: true },
  ],
};
...
export const ORIENTATION_DAYS = [
  ...
  { day: 7, label: "Day 7", date: "25 Aug (Tue)", title: "Speaker Session, Quiz & CR Elections, Clubs & Grand FUN Event 🎉" },
];
