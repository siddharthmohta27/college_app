...
const FALLBACK_PROFILES = [
  {
    ...
    year: "3rd Year",
    major: "Design",
    bio: "Always sketchin' in class. Coffee lover, indie music fan, and looking for someone to review campus cafes with!",
    interests: ["Art", "Indie Rock", "Cafes", "UI/UX"],
    emoji: "🎨",
    verified: true,
  },
  {
    ...
    bio: "Car enthusiast, amateur guitar player, and gym regular. Let's study (or skip lectures) together.",
    interests: ["Gym", "Guitars", "Anime", "Formula 1"],
    emoji: "🎸",
    verified: false,
  },
  {
    ...
    year: "2nd Year",
    major: "Economics",
    bio: "If you love debate, board games, and late night chai, we will probably get along. Bookworm 📚",
    interests: ["Chai", "Debating", "Chess", "Reading"],
    emoji: "♟️",
    verified: true,
  },
  {
    ...
    bio: "I build websites and compile errors for fun. Let's match if you want someone to debug your life.",
    interests: ["Coding", "Hackathons", "Valorant", "Memes"],
    emoji: "💻",
    verified: true,
  },
  {
    ...
    year: "3rd Year",
    major: "English Lit.",
    bio: "Poetry, street photography, and vintage vinyl records are my jam. Tell me your favorite movie?",
    interests: ["Poetry", "Cinema", "Vinyls", "Travel"],
    emoji: "📷",
    verified: false,
  },
];
...
router.get("/profiles", async (req, res) => {
  ...
  if (!dbAvailable) {
    ...
    return res.json({
      profiles: FALLBACK_PROFILES.filter((p) => p.id !== userId),
      source: "fallback",
    });
  }
